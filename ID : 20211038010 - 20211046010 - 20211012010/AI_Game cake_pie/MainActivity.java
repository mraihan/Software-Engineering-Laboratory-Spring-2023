            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(60000, 1000){
                    ...
                    public  void onFinish(){
                        ...
                        result_b.setText(" player2 win ");
                    }
                }.start();
                if(toss==0|| toss==1 || toss==2){
                    Toast.makeText(MainActivity.this, "Player2 has won the toss", Toast.LENGTH_LONG).show();
                    t=0;
                    action_of_ai();
                }
...
//        System.exit(0);
    ...
    public void game_result(){
        if(player1>player2) {
            ...
            result_b.setText("" + " Player1 Win by " + diff + "");
            ...
            result_b.setText("" + " player2 Win by " + diff + "");
    ...
    public void  action_of_click(){
        if(t==0){
            ...
            tv1.setText("" + "  Player1 point  " + player1 + "");
            tv2.setText("" + "     player2 point   " + player2 + "");
    ...
    public  void  action_of_ai(){
        int c=ai_choose();
        int tbl=c+1;
        // Toast.makeText(MainActivity.this, "player2 choose"+tbl, Toast.LENGTH_LONG).show();
