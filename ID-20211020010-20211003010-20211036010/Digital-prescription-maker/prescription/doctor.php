...
<div class="container mt-5">
  <div class="row">
    ...
    <div style="font-size:18px;font-weight:600">Doctor list  </div>
    <ul class="list-group list-group-flush" style="margin-top:32px">
    <?php 

   
    $sel = "SELECT *,(select name from user where user.id = compounder.doctor) as name FROM `compounder` where compounder = '$uuid' order by id desc";
