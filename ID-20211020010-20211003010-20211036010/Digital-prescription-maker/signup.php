...
if(isset($_POST['signup'])){
  ...
  $type = $_POST['type'];
  $uuid = rand(10000,99999);

  $insert  = "INSERT INTO `user`(`name`, `email`, `password`,`type`,`uuid`)
   VALUES ('$name','$email','$password','$type','$uuid')";
...
<div class="container mt-5" >
          ...
          <div style="width: 400px;padding:16px;background:#fff;margin:auto">
                ...
                <div class="mb-3">
                  <label for="pwd" class="form-label">Account type:</label>
